...
function playSample() {
  ...
  request.open("GET", "src/snitch.mp3", true);
  request.responseType = "arraybuffer";

  // When loaded decode the data
  request.onload = function () {
    $("#title").html("Like That");
    $("#album").html("Like That");
    $("#artist").html("Fox Stevenson");
    onWindowResize();
...
//   if (navigator.userAgent.indexOf("Chrome/53.0.2764.0") > -1) {
//     //besserer Look in Chrome Canary
